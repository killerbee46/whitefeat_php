...
function queryFilter() {
	...
	if (array_key_exists('price',$_GET)) {
		...
		if (array_key_exists('tags',$_GET)) {
			 $tagv='';
	  if($_GET['tags']=='kid'){$tagv='tag_kid';}
	  if($_GET['tags']=='men'){$tagv='tag_men';}
	  if($_GET['tags']=='women'){$tagv='tag_women';}
	  if($_GET['tags']=='gift'){$tagv='tag_gift';}
...
<div class="container is-fluid" style="background: rgb(241,243,244); margin-top:20px;
...
<div class="columns p-2 product-list-wrapper">
  ...
  <div class="card-image" style="background:url(../../../v2/images/no-image.avif)">
    <figure class="image">
