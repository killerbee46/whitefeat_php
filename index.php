...
<div class="container is-fluid" style="padding-top:1.5em; background:linear-gradient(
  ...
  #33333380,
  #33333380
),url('https://imgs.search.brave.com/M59sGj9ooioRQoFuNy1lITZY2RzsnFw2ySF0HmrBpKs/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9tZWRp/YS5pc3RvY2twaG90/by5jb20vaWQvMTI4/MjY5MzQ2MC9waG90/by9ibGFjay1hbmQt/Z29sZC1nbGl0dGVy/LWJhY2tncm91bmQt/Y2hyaXN0bWFzLWNl/bGVicmF0aW9uLWx1/eHVyeS5qcGc_Yj0x/JnM9NjEyeDYxMiZ3/PTAmaz0yMCZjPWhh/T09QelRjQ25HQXNJ/VlQ5MGR2SlRWQmd3/dHhIWjBBWXRMMUxx/YndRQ289'),#231535;color:white;background-size:cover;background-repeat:no-repeat; margin-top:3em">
			<div style="display:flex;justify-content:space-between;align-items:baseline;">
				<div
					style="color:gold;font-size: 20px;font-weight:700;width: max-content;padding-bottom:10px;border-bottom:1px solid #A65FF3;margin-bottom:40px;">
					12-12 Offer Nose Pin
				</div>
				<?php
				$sqlOffer = "Select p_name, id_pack,image from package where cat_id = 222 ";
			...
			<div style="display:flex;justify-content:center;">
				...
				<div style="width:300px;margin:20px auto;cursor:<?= $offerExpired ? "not-allowed":'default' ?>" title="<?= $offerExpired ? "Offer Has Expired":'' ?>">
					<?php
  ...
  <a class="';
echo $offerExpired ? 'disabled " title="Offer Has Expired" ' : ' "';
