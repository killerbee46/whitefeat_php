...
<div class="title flex align-center" style="margin-bottom:-20px;margin-left:20px; gap:10px; margin-top:40px;"> <img src="assets/v2/images/cart.png" width="25px" />Your Shopping Cart<span>
  (<?php 
...
<ul class="steps is-narrow is-medium is-centered has-content-centered p-4 has-background-light each_item" style=" border:1px solid #eee; ">
  ...
  <h4 class="checkout_h4">Total (<?php echo $countcw; ?> Item<?php if($countcw>1){echo'';} ?>) : <?php 
...
// currency 
  ...
  ?><span class="total_cost"></span></h4>
   ...
   <div class="columns is-multiline each_item m-0 p-4 has-background-light confirm-success has-text-centered" style="display:none; height:65VH;" >
         <div class="column is-12 " style="padding-bottom:2em;">
		   <h4 class="subtitle letter-spacing"><i class="fas fa-check-circle has-text-success is-size-3"></i>&nbsp; Congratulations! Your purchase order has been processed successfully. <br>
		   </h4>
    ...
    $discount = $dynamicPrice['discount'];
	  ...
	  echo'" alt="product image" class="card-img-top" style="height:7.3em; width:auto;"/></a>
		...
		<div class="column is-7">
		  ...
		  if($rowactx['size']!='0'){echo'Size: '.$rowactx['size'].', &nbsp;';}
		  echo'Qty &nbsp;
		  <select class="qty_sel_checkout" data-ref="'.$rowactx['cart_id'].'">';
		  
		  for($i=1;$i<11;$i++){
			  echo'<option '; 
			  if($i==$rowactx['qty']){echo'selected';}
...
// currency 
   ...
   echo'&nbsp;'; 
   if($b2b_check==1){echo'<span class="has-text-weight-normal is-size-6" style="opacity:0.6;"><small><small><small>B2B rate</small></small></small></span>';}
...
<a href="#"> <small><span class="noPass"><i class="fas fa-hand-o-right"></i> Forgot your password?</span></small></a>
  ...
  <span class="fpass1" style="display:none;">
   <div class="col-md-12 forgot_phone">
    ...
    <input type="number" class="input exampleFormControlInputPhone2" id="exampleFormControlInputPhone2" placeholder="98XXXXXXX">
        </div>
	  </div>
 ...
 <button class="button is-success confirmOtp" data-checkout="1">Confirm OTP &nbsp;<i class="fa fa-check-circle"></i></button>
...
<div class="field">
 ...
 <button class="button is-success confirmOtpSignup" data-checkout="1">Confirm OTP &nbsp;<i class="fa fa-check-circle"></i></button>
  ...
  <div class="columns mb-2 mt-2 pl-4 has-text-semibold resend_otpSignup">
    <strong>Didn't get code? please wait...</strong>
	   ...
	   <div class="columns has-background-white mt-3 is-multiline each_item mr-3 delivery-info" style="display:none;">
	    
		
		<div class="column is-12 p-3 pl-5 " style="border-top:1px solid #eee; background:#eee;">
		<span class="pl-0 is-size-6 has-text-weight-semibold is-fullwidth"><i class="fas fa-check has-text-success is-size-5"></i> &nbsp; 1.&nbsp; Logged In: &nbsp;<small class="has-text-info"> <i class="fas fa-user-circle is-size-6"></i> <span class="user-name"></span> (<span class="user-phone"></span>) </small> 
		 </span>
	     </div>
...
<label class="label">Contact Number:</label>
  <p class="control has-icons-left">
    <input class="input del-phone" type="text" id="exampleFormControlInputPass" placeholder="Phone number">
    <span class="icon is-small is-left">
...
<div class="field">
<label class="label">Message: <small class="is-size-7 has-text-weight-light">(optional)</small></label>
  <p class="control has-icons-left">
    <textarea class="input del-msg" type="text" id="exampleFormControlInputPass" placeholder="Any message" style="height:10VH;"></textarea>
    <span class="icon is-small is-left">
...
<div class="field mt-4">
  <p class="control">
    <button class="button is-normal is-fullwidth proceed-payment" style="background: rgb(241,243,244);
background: linear-gradient(90deg, rgba(241,243,244,1) 0%, rgba(226,225,219,1) 34%, rgba(80,225,255,1) 80%, rgba(116,228,250,1) 98%);">
    ...
    <div class="field letter-spacing mt-2">
      <label class="b-radio radio is-large">
        ...
        <span class="control-label is-size-6"><img src="assets/images/khl.png" style="height:3em;"/></span>
      </label>
    </div>
    ...
    <div class="field letter-spacing">
      <label class="b-radio radio is-large">
        ...
        <span class="control-label is-size-6"><img src="assets/images/esewa.png" style="height:3.5em;"/></span>
      </label>
    </div>
	
	<div class="field mt-4">
  <p class="control">
    <button class="button is-normal confirm-order" style="background: rgb(241,243,244); width:100%;
background: linear-gradient(90deg, rgba(241,243,244,1) 0%, rgba(226,225,219,1) 34%, rgba(80,225,255,1) 80%, rgba(116,228,250,1) 98%);">
      <span id="pay_show" style="display:none;">Pay & &nbsp; </span>Confirm Order  &nbsp; <i class="fas fa-check-circle"></i>
    </button>
  </p>
</div>
...
<div class="column is-4 p-5 checkout-mright-div process-div"> 
  ...
  <h4 class="is-size-6 has-text-weight-semibold">Order Summary</h4>
   ...
   <div class="columns pl-4 pr-4">
	...
	<div class="column is-6 pb-2 letter-spacing is-size-6 has-text-weight-semibold has-text-right checkout_right_div">
	<?php echo $cnot." ".floor(($crate*$total_net)); echo'<input type="hidden" id="tcost" value="'.floor(($crate*$total_net)).'" />'; ?> 
	</div>
	</div>
   ...
   <button class="button is-normal is-fullwidth first-checkout" data-ref="<?php echo $GLOBALS['customer']; ?>" data-ref2="<?php
    if($GLOBALS['customer']!='0'){
...
background: linear-gradient(90deg, rgba(241,243,244,1) 0%, rgba(226,225,219,1) 34%, rgba(80,225,255,1) 80%, rgba(116,228,250,1) 98%); border:0;"><i class="fas fa-shopping-cart"></i> &nbsp; Checkout Now</button>
   </div>
		 ...
		 else{echo'<div class="columns mt-4 p-5 has-text-centered" style="height:80.5VH; text-align:center;">
		 
		 <div class="column card" style="padding-top:5em;">
		 <img src="assets/images/extra/cart-empty.png" style="height:10em;"/>
...
$(document).on('click','.proceed-payment', function(){
   ...
   $.ajax({url: "deliverycart",data: dataString, type: 'POST', cache: false,
...
$(document).on('click','.confirm-order', function(){
	...
	if(pmode==='1'){
		//COD
	$.ajax({url: "confirmcart",data: dataString, type: 'POST', cache: false,
			success: function(result){
