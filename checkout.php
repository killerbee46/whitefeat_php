<?php {
  ...
  <body style="letter-spacing:0.02em; background-color:#F9F9FA;">
    ...
    <div class="title flex align-center" style="margin-bottom:-20px;margin-left:20px; gap:10px; margin-top:40px;"> <img
        src="assets/v2/images/cart.png" width="25px" />Your Shopping Cart<span>
        (<?php
                  ...
                  <div class="container" style="margin-top:2em; width:100%;">
                    ...
                    <div class="field letter-spacing">
                      <label class="b-radio radio is-large">
                        ...
                        <span class="control-label is-size-6"><img src="assets/images/esewa.png"
