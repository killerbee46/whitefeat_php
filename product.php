...
-webkit-box-orient: vertical;" class="p-2">' . strtoupper($rowpw['p_name']) . '</span> </span>
  ...
  <span class="icon is-left">
    <i class="fas fa-check-circle"></i>
          ...
          <?php
              if ($rowpd['pmt_id'] > 0 && $rowpd['pmt_id'] < 10 && $rowpd['cat_id'] != 81) {
                ...
                <div title="Luxury Tax on Gold"
                  ...
                  <div style="margin:0;"><?= round($luxTax['lux_tax'], 0) ?>% Lux Tax <span
                      style="font-size: 10px;margin:0">On Gold</span></div>
                </div>
              </div>
            </div>
              <?php } ?>
