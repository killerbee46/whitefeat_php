...
<script>
	...
	setInterval(function () {
		...
		$('.head-notify[data-id="' + nturn + '"]').fadeIn(1200); hnturn = nturn;
	}, 2500);
	/* Top header notificaiton scroll one after another start*/
</script>
...
<script>
	...
	$('.checkU').click(function () {
		if (($('.exampleFormControlInputPhone').val() != '') && ($('.exampleFormControlInputPass').val() != '')) {
			...
			$.ajax({
				url: "clogin/" + $('.exampleFormControlInputPhone').val() + "-" + $('.exampleFormControlInputPass').val(), cache: false,
	...
	$('.checkEmail').click(function () {
		$.ajax({
			url: "cemail/" + $('.exampleFormControlInputPhone2').val(), cache: false,
			success: function (result) {
				//alert(result);
	...
	$(document).on('click', '.signupOtp', function () {
		...
		$.ajax({
			url: "signup/" + $('.signUpnew').val(), cache: false,
			success: function (result) {
	...
	$(document).on('click', '.rsend_otpSignup', function () {
		$.ajax({
			url: "cemail/" + cphoneSignup, cache: false,
			success: function (result) {
				alert('Code Resent');
				$('.resend_otpSignup').html('');
	...
	$('.confirmOtpSignup').click(function () {
		...
		$.ajax({
			url: "cotp/" + $('.otpnumSignup').val() + '-' + cphoneSignup,
			cache: false,
			success: function (result) {
...
<script>
	...
	$('.send_home_appoint').click(function () {
		...
		$.ajax({
			url: "savehome", data: dataString, type: 'POST', cache: false,
			success: function (result) {
...
<script>
	...
	$('.add_cart').click(function () {
		...
		$.ajax({
			url: "savetocart", data: dataString, type: 'POST', cache: false,
			success: function (result) {
	...
	$('.del_checkout_item').click(function () {
		...
		$.ajax({
			url: "cartdel", data: dataString, type: 'POST', cache: false,
			success: function (result) {
				location.reload(true);
			}
		});
	...
	$('.move_checkout_item').click(function () {
		...
		$.ajax({
			url: "cartwish", data: dataString, type: 'POST', cache: false,
			success: function (result) {
	...
	$('.qty_sel_checkout').on('change', function () {
		...
		$.ajax({
			url: "cartqty", data: dataString, type: 'POST', cache: false,
			success: function (result) {
				location.reload(true);
			}
		});
...
<script>
	...
	$(document).on('click', '.subscribe', function () {
		if ($('.subs_email').val() != '') {
			var dataString = 'subs=' + $('.subs_email').val();
			$.ajax({
				url: "subscriber",
				data: dataString,
				type: 'POST',
...
<script>
	...
	$('.add_wish_product').click(function (evt) {
		...
		$.ajax({
			url: "savewish", data: dataString, type: 'POST', cache: false,
			success: function (result) {
	...
	$('.remove_wish').click(function (evt) {
		...
		var dataString = 'idp=' + idp;
		$.ajax({
			url: "removewish", data: dataString, type: 'POST', cache: false,
			success: function (result) {
				location.reload(true);
			}
		});
...
<script>
	...
	$('.sign-out').click(function () {
		$.ajax({
			url: "signout", data: 'true_user', type: 'POST', cache: false,
			success: function (result) {
				location.reload(true);
			}
		});
	...
	$('.save_details').click(function () {
		...
		$.ajax({
			url: "saveudetail", data: dataString, type: 'POST', cache: false,
			success: function (result) {
	...
	$('.save_pass').click(function () {
		if ($('.np1').val() === $('.np2').val()) {
			...
			$.ajax({
				url: "saveupdetail", data: dataString, type: 'POST', cache: false,
				success: function (result) {
