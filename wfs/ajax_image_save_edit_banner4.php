...
$targetPath = "../assets/images/banner4/".$newfilename; // Target path where file is to be stored
...
$sql2="UPDATE `whitefeat_wf_new`.`banner4` SET s_path='$newfilename', package_link='$sl', title_link='$sl2', hyper_link='$sl3' WHERE b_id='$g1'";
...
$sql2="UPDATE `whitefeat_wf_new`.`banner4` SET package_link='$sl', title_link='$sl2', hyper_link='$sl3' WHERE b_id='$g1'";
mysqli_query($con,$sql2); 
}
