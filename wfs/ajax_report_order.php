            ...
            <div class="card card-secondary"style="padding-bottom:1em; margin-bottom:0">
              <div class="card-header">
                <h3 class="card-title"><i class="fas fa-chart-bar"></i> &nbsp; Order Report <small>B2C</small> </h3>
  ...
  <div class="callout callout-primary alert">
                  <h5><i class="fas fa-cubes"></i> Orders  <small>(B2C)</small>
			  ...
			  <div class="col-2">
			  <label>&nbsp;</label>
			  <button class="btn btn-flat form-control btn-outline-primary view_report_sales_table">View Report</button>
			  </div>
			  </div>
  ...
  <div class="callout callout-primary alert">
                  <h5><i class="fas fa-shopping-bag"></i> Sales  <small>(B2C)</small>
			  ...
			  <div class="col-2">
			  <label>&nbsp;</label>
			  <button class="btn btn-flat form-control btn-outline-primary view_report_sales_table_2">View Report</button>
			  </div>
			  </div>
