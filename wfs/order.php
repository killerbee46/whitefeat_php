...
<div class="row">	
 <div class="col-12">
            ...
            <div class="card card-success card-outline card-outline-tabs">
			  ...
			  <div class="card-tools">
                ...
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
				  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-four-home-tab-stock" data-toggle="pill" href="#custom-tabs-four-home-stock" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true"><i class="fas fa-file"></i> New Orders</a>
                  </li>
				  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true"><i class="fas fa-edit"></i> On Delivery</a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="card-body">
				...
				<div class="tab-pane fade active show p-1" id="custom-tabs-four-home-stock" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab-stock">
					...
					<div class="row" style="background:rgba(0,0,0,0.02); padding:0.5em; font-size:1.3em; border:1px solid #eee;">
					  <div class="col-2">
						ID.   
				      </div>
					  <div class="col-2">
					  ...
					  <div class="col-1">
						<small>QTY</small> <small><small><small>(cart)</small></small></small>   
				      </div>
                    ...
                    $displayol = mysqli_query($con,$queryol); $total_net=0; $sn=1;
                     while($rowol = mysqli_fetch_array($displayol))
			          {
						...
						echo'" style=" border:1px solid #eee;">
						  ...
						  if(isset($rowol1['b2b']) && $rowol1['b2b']=='1'){echo'&nbsp;<span class="badge badge-danger"><i class="fas fa-star"></i>&nbsp; B2B</span>';}
						  else{echo'&nbsp;<span class="badge badge-warning"><i class="fas fa-star"></i>&nbsp; B2C</span>';}
						  echo '<div style="margin:5px auto;text-transform:capitalize;">'. $rowol['name'].'<br />'.$rowol['cno'].'</div>';
						   echo'<br>#WFO-'.$rowol['cb_id'];if($rowol['mode']=='1'){echo'&nbsp;<span class="badge badge-secondary">COD</span>';}if($rowol['mode']=='2'){echo'&nbsp;<span class="badge badge-info">KHALTI</span>';}if($rowol['mode']=='3'){echo'&nbsp;<span class="badge badge-success">ESEWA</span>';}echo'
						  </div>
						  <div class="col-2">
						   '.$rowol['p_date'].'
						  </div>
      ...
      $displayacw=mysqli_query($con,$sql1acw); $tqty=0;
	  ...
	  echo $cnot.' '.floor(($crate*$total_net));
						  ...
						  <div class="col-12 pt-2 pb-2" style="border-top:1px solid #fafafa;">';
	  ...
	  echo'<img src="../assets/images/product/thumb/'.$rowckp2['s_path'].'" style="height:6em;"/>';
	  ...
	  echo' &diams; '.ucfirst($rowckp1['p_name']).' - <b>Qty: '.$rowckp1['qty'].'  &nbsp; </b><span><a href="../'.make_url($rowckp1['p_name']).'" target="_blank"><i>View Product </i><i class="fas fa-eye"></i></a></span></small></small></h6>';
					  ...
					  if($sn==1){echo'<p class="p-3">No new orders to display !</p>';}
					 ?>
                     ...
                     while($rowol = mysqli_fetch_array($displayol))
			          {
						...
						echo'" style=" border:1px solid #eee;">
                          ...
                          $displayol1 = mysqli_query($con,$queryol1);
                          $rowol1 = mysqli_fetch_array($displayol1);
						  if($rowol1['b2b']=='1'){echo'&nbsp;<span class="badge badge-danger"><i class="fas fa-star"></i>&nbsp; B2B</span>';}
						  else{echo'&nbsp;<span class="badge badge-warning"><i class="fas fa-star"></i>&nbsp; B2C</span>';}
						  echo'<br><small><code>'.$rowol1['name'].'</code></small>';
						  echo'<br>#WFO-'.$rowol['cb_id'];if($rowol['mode']=='1'){echo'&nbsp;<span class="badge badge-secondary">COD</span>';}if($rowol['mode']=='2'){echo'&nbsp;<span class="badge badge-info">KHALTI</span>';}if($rowol['mode']=='3'){echo'&nbsp;<span class="badge badge-success">ESEWA</span>';}echo'
						  </div>
						  <div class="col-2">
						   '.$rowol['p_date'].'
	  ...
	  echo'<small><small>&diams; '.ucfirst($rowckp1['p_name']).' - '.$rowckp1['qty'].'</small></small>';
					  ...
					  if($sn==1){echo'<p class="p-3">No delivery orders to display !</p>';}
					 ?>
	  ...
	  echo'<small><small>&diams; '.ucfirst($rowckp1['p_name']).' - '.$rowckp1['qty'].'</small></small>';
					  ...
					  if($sn==1){echo'<p class="p-3">No orders to display !</p>';}
					 ?>
        ...
        <div class="modal-dialog" >
          <div class="modal-content">
			...
			<div class="modal-header">
			 ...
			 <button class="btn btn-flat btn-outline-info" id="print_stock_status"><i class="fas fa-print"></i> &nbsp;Print</button>
