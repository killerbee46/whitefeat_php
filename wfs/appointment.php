...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" id="navmenu">
    ...
    <ul class="navbar-nav ml-auto">
	  ...
	  <li class="nav-item">
        <a class="nav-link btn btn-light"  href="#" role="button" id="re_print_bill" data-toggle="modal" data-target="reprint_modal">
            ...
            <div class="card card-success card-outline card-outline-tabs">
			  ...
			  <div class="card-tools">
                ...
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
				  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-four-home-tab-stock" data-toggle="pill" href="#custom-tabs-four-home-stock" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true"><i class="fas fa-house-user"></i> New Appointment</a>
                  </li>
				  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true"><i class="fas fa-check-square"></i> Visited </a>
                  </li>
              ...
              <div class="card-body">
				...
				<div class="tab-pane fade active show p-1" id="custom-tabs-four-home-stock" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab-stock">
					...
					$queryol = "Select * from `whitefeat_wf_new`.`inquiry` where visit='0' order by inquiry_id DESC"; 
                    $displayol = mysqli_query($con,$queryol); $total_net=0; $sn=1;
					 ...
					 echo $rowolx2['p_name'];
					  ...
					  if($sn==1){echo'<p class="p-3">No new appointments to display !</p>';}
                  ...
                  <div class="tab-pane fade" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
					...
					$queryol = "Select * from `whitefeat_wf_new`.`inquiry` where visit='1' order by inquiry_id DESC"; 
                    $displayol = mysqli_query($con,$queryol); $total_net=0; $sn=1;
                     while($rowol = mysqli_fetch_array($displayol))
			          {
