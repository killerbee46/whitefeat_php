    ...
    <div class="modal" id="custom-design-modal">
        ...
        <div class="modal-content">
            <div class="box">
                ...
                <hr />
                <img class="modal-cover" src="assets/v2/images/custom-des.png" />
                <div class="modal-info">
                    <img src="assets/v2/images/whatsapp-qr-wf.png" class="whatsapp-qr" alt="Whatsapp qr" />
                    <div class="modal-info-list">
                        <div class="modal-info-list-item">
                            <span><img src="assets/v2/images/green-tick.png" width="15px" height="15px" /></span> <span>Get on a live
                                video call with our design consultants.</span>
                        </div>
                        <div class="modal-info-list-item">
                            <span><img src="assets/v2/images/green-tick.png" width="15px" height="15px" /></span> <span>Live Available On
                                <b>Whatsapp, Viber & Messenger!</b></span>
                        </div>
                        <div class="modal-info-list-item">
                            <span><img src="assets/v2/images/green-tick.png" width="15px" height="15px" /></span> <span>SUN - SAT ( 9am
                                to 6pm )</span>
                        </div>
                        <div class="modal-info-list-item">
                            <span><img src="assets/v2/images/green-tick.png" width="15px" height="15px" /></span> <span>OPENS 365 DAYS!
                                <a
...
<div class="modal-cover" style="background-image:url(assets/v2/images/jwell-sell.jpg);"></div>
                    <!-- <img class="modal-cover" src="assets/v2/images/jwell-sell.jpg" /> -->
                    <div class="modal-info">
                        <img src="assets/v2/images/whatsapp-qr-wf.png" class="whatsapp-qr" alt="Whatsapp qr" />
                        ...
                        <div class="modal-info-list-container">
                            <div class="modal-info-list">
                                <div class="modal-info-list-item">
                                    <span><img src="assets/v2/images/green-tick.png" width="15px" height="15px" /></span> <span>Get on a
                                        live
                                        video call with our design consultants.</span>
                                </div>
                                <div class="modal-info-list-item">
                                    <span><img src="assets/v2/images/green-tick.png" width="15px" height="15px" /></span> <span>Live
                                        Available On
                                        <b>Whatsapp, Viber & Messenger!</b></span>
                                </div>
                                <div class="modal-info-list-item">
                                    <span><img src="assets/v2/images/green-tick.png" width="15px" height="15px" /></span> <span>SUN - SAT
                                        ( 9am
                                        to 6pm )</span>
                                </div>
                                <div class="modal-info-list-item">
                                    <span><img src="assets/v2/images/green-tick.png" width="15px" height="15px" /></span> <span>OPENS 365
                                        DAYS!
                                        <a target="_blank"
                                            href="https://www.google.com/maps/place/White+Feathers+Jewellery/@27.7027815,85.3085035,17z/data=!3m1!4b1!4m6!3m5!1s0x39eb190051eb7d6d:0x345d8d98fffd34e7!8m2!3d27.7027768!4d85.3110784!16s%2Fg%2F11fklpz4dp?entry=ttu&g_ep=EgoyMDI1MDYxNy4wIKXMDSoASAFQAw%3D%3D">
                                            Location Map
    ...
    <div class="modal" id="login-modal">
        ...
        <div class="login-modal-content">
            <div class="box">
                <h2>Free Try at Home</h2>
                <hr />
                <img class="login-modal-cover" src="assets/v2/images/free-try.webp" />
                <div class="login-modal-info">
                    <img src="assets/v2/images/whatsapp-qr-wf.png" class="whatsapp-qr" alt="Whatsapp qr" />
                    <div class="login-modal-info-list">
                        <div class="login-modal-info-list-item">
                            <span><img src="assets/v2/images/green-tick.png" width="15px" height="15px" /></span> <span>Get to try our
                                products.</span>
                        </div>
                        <div class="login-modal-info-list-item">
                            <span><img src="assets/v2/images/green-tick.png" width="15px" height="15px" /></span> <span>Free
                                Drop-In.</span>
                        </div>
                        <div class="login-modal-info-list-item">
                            <span><img src="assets/v2/images/green-tick.png" width="15px" height="15px" /></span> <span>Excellent
                                Services.</span>
                        </div>
                    </div>
                </div>
 ...
 <button class="button is-success confirmOtpSignup">Confirm OTP &nbsp;<i class="fa fa-check-circle"></i></button>
  ...
  <div class="topbar">
                <div class="topbar-item" onclick="openModal('home-try-modal')">
                    <img class="topbar-item-img" src="assets/v2/images/home-white.png" alt="more info" /> Free Try at Home
                </div>
                <div class="topbar-item" onclick="openModal('custom-design-modal')">
                    <img class="topbar-item-img" src="assets/v2/images/custom-white.png" alt="more info" /> Custom Design
                </div>
...
<nav class="navbar">
                <div class="flex justify-between">
                    <div class="logo-menu-container flex align-center">
                        <a href="/"><img src="assets/v2/images/wflogo.png" class="logo" /></a>
                        <div class="menus">
...
<?php } ?>
    ...
    <div class="default-curr" style="padding-top:0;">
                                        <image class="icons" src="assets/v2/images/nep.png" alt="user detail" /> NPR
                                    </div>';
	}
	    ...
	    if($trigger==2)
		{
			echo'
    <div class="default-curr" style="padding-top:0;">
                                        <image class="icons" src="assets/v2/images/aus.png" alt="user detail" /> AUD
                                    </div>';
		...
		if($trigger==3)
		{
		  	echo'
    <div class="default-curr" style="padding-top:0;">
                                        <image class="icons" src="assets/v2/images/usa.png" alt="user detail" /> USD
                                    </div>';
		}
	    ...
	    if($trigger==4)
		{
		  	echo'
    <div class="default-curr" style="padding-top:0;">
                                        <image class="icons" src="assets/v2/images/euro.png" alt="user detail" /> EUR
                                    </div>';
		}
...
?>
  ...
  ?>
                            ...
                            <div class="menu-drawer-toggle hidden-big-screen">
                                <div id="menu-toggle">
                                    <image onclick="openDrawer('custom-menu-drawer')" class="icons" src="assets/v2/images/menu.png"
                                        alt="menu icon" />
                                </div>
