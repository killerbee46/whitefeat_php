...
<?php
  ...
  /*for verification payment call end */
    ...
    CURLOPT_HTTPHEADER => array(
        'Authorization: key live_secret_key_da719cdf0f53462aa6bfd38e8ed32e0d',
 ...
 if($result['status']=='Completed'){
	  ...
	  $getid=explode("-",$_GET['purchase_order_id']);
	    $tracking=time().round(microtime(true)).$GLOBALS['customer'];
	  ...
	  $sql = "update `whitefeat_wf_new`.`cart_book` set tracking_code='".$tracking."', checkout='1', mode='$paym', p_date='$tdate', cur_id='".$rowft2['cookie_currency']."', khalti_code='".$_GET['transaction_id']."' where  cb_id='".$getid[1]."'";
  ...
  QRcode::png($text,$location);
      ...
      <div class="column is-12">
	    <h3 class="subtitle"><i class="fas fa-check-circle is-size-2 has-text-info"></i> &nbsp; Payment Sucess !</h3> <hr>
		
		<img src="assets/images/khl.png" style="height:3em;"/>
		<h4>Congratulation! Your Khalti payment was processed successfully! <Br> </h4>
	  </div>
...
is-offset-one-quarter mt-2 mb-2 card has-background-white has-text-dark " style="">
  ...
  +977 - 9806091605  , if you have any issue. 
	  ...
	  <div class="column is-12">
	  <hr>
	     <a href="cart" style="position:absolute; margin-top:0.4em; font-size:1.2em; font-weight:100;"><I class="fas fa-arrow-left"></I>&nbsp; &nbsp; </a><a href="cart"><img src="assets/images/logo.png" style="height:38.3px; margin-left:3em;"/> &nbsp; </a>
	  </div>
 ...
 echo'<div class="columns card is-multiline has-text-centered">
      <div class="column is-12">
		...
		<img src="assets/images/khl.png" style="height:3em;"/>
		<h4>Sorry! We couldn'."'".'t process your khalti payment! <Br>
