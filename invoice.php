...
<link rel="stylesheet" href="bill/style.css">
 <style>
 @media print {
         .inv_title {margin-top:1.5em;}
		 .img_logo{margin-top:0.5em!important; margin-right:-0.2em!important;}
      }
	  </style>
</head>
...
<a href="#"><h4 class="inv_title">INVOICE</h4></a></div>
</div>
<div class="col-auto"><h1 class="big-title"><img src="assets/images/logo.png" alt="WF" style="height:1.6em; position:relative; margin-top:-1em; margin-right:-0.5em;" class="img_logo"/></h1></div>
</div>

<div class="header-bottom" style="margin-top:2.8em;"><div class="row align-items-center justify-content-end"><div class="col-auto"><p class="invoice-number me-4"><b>Invoice No: </b>#WFO-<?php echo $rowm['cb_id'];?></p></div><div class="col-auto"><p class="invoice-date"><b>Date: </b><?php echo $rowm['p_date']; ?></p></div></div></div>
</header>
...
<div class="col-3">
<img src="qrimages/<?php echo $rowm['tracking_code'].'.png'; ?>" style="height:5em;"/>
</div>
<div class="col-6 invoice-left">
<b>Invoiced To:</b><address><?php 
      echo $rowm['name'];
	  ?><br><?php echo $rowm['address'];?><br><?php echo $rowm['cno'];?></address></div>
</div>
</div>
<div class="col-auto">
<div class="invoice-right"><b>Pay To:</b><address>White Feather's Inc. Pvt. Ltd.<br>Newroad, Kathmandu, Nepal
<br>+977-01-5365343, +977-9806091605</address>
</div>
</div>
</div>
...
<?php 
      ...
      $displayld=mysqli_query($con,$sqlld); $sn=1;
	 ...
	 //b2b check
	  ...
	  $total_net=$total_net+($newprice*$rowld['qty']);
		  ...
		  // currency 
      $sel_cur=$rowm['cur_id'];  $cnot=''; $crate=1;
	  ...
	  echo $cnot.' '.floor(($crate*$rowld1['price']));
		  ...
		  if($rowld['size']>0){echo'&nbsp; <small><small><small>(Size): </small></small> <small><b>'.$rowld['size'].'</b></small></small>';}
		  echo'</td><td>';
...
<b>Payment Mode:</b>
<p class="mb-0"><?php
 if($rowm['mode']=='1'){echo'Cash on delivery';}
 if($rowm['mode']=='2'){echo'Khalti';}
 if($rowm['mode']=='3'){echo'Esewa';}
...
<script src="bill/main.js"></script></body>
