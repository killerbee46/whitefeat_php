<?php {
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Silver Investment | White Feathers Jewellery</title>
        ...
        <div class="container is-fluid mt-3">
            ...
            <div class="columns mt-5">
              ...
              object-position: center center;">
                ...
                <div class="column is-7 ml-2 scroll-filter-product"
                    style="margin-top:2.2em; height:80VH; overflow-y:scroll;">
  ...
  <a href="wishlist"><i class="fas fa-heart is-size-4" style="color:#3892C6; font-size:1.2rem; z-index:11;"></i></a>&nbsp; &nbsp; ';
                            ...
                            <span class="has-tooltip-arrow has-tooltip-multiline has-tooltip-bottom pb-1 modal-smv"
                                data-tooltip="View similar products" data-target="modal-smp"><i
                                    class="far fa-clone is-size-4" style="color:#3892C6;"></i></span>
  ...
  <span class="tag is-';
   ...
   <h3 class="is-size-4 has-text-weight-semibold" style="color:#333;">';
                    ...
                    <div class="" style="margin-top:-1.2em; letter-spacing:1.5px;">
                        ...
                        if ($GLOBALS['customer'] == 0) {
                            ?>
                            <span data-target="modal-user" class="user-modal contains-number big-screen">
                        ...
                        <?php } else {
                            ...
                            <?= $rowpd['visible'] ? "" : " <div style='color:crimson;font-weight:600;'>Can Only Place Orders Between 11:30 AM to 5:30 PM Sunday to Friday</div>" ?>
