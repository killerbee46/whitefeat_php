...
-moz-box-shadow: 0px 1px 5px 1px rgba(125,121,121,0.32);">
  ...
  <a href="/" style="position:absolute; margin-top:0.4em; font-size:1.2em; font-weight:100;"><I class="fas fa-arrow-left"></I>&nbsp; &nbsp; </a><img src="assets/images/logo.png" style="height:38.3px; margin-left:3em;"/>
  </div>
  
  <div class="column m-0 d-nav is-5 mg-menu" style="padding-top:0.6em;">
  <div class="header_title">
 <span class="subtitle letter-spacing"><i class="fas fa-user-circle is-size-4"></i>&nbsp; <span id="vendor_on">Customer</span> Dashboard</span> 
</div></div>
